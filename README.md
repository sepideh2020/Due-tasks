In this mini-project users can set task for them selves and set Category for each task. After setting task for each task users can sort the tasks based on their category.
